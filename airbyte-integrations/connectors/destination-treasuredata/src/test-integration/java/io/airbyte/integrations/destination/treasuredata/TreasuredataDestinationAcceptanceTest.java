...
package io.airbyte.integrations.destination.treasuredata;
...
public class TreasuredataDestinationAcceptanceTest extends DestinationAcceptanceTest {

  private static final Logger LOGGER = LoggerFactory.getLogger(TreasuredataDestinationAcceptanceTest.class);

  private JsonNode configJson;

  @Override
  protected String getImageName() {
    return "airbyte/destination-treasuredata:dev";
  }
